...
namespace hrm_api.Controllers.hr
{
    ...
    {
        private readonly ICurrencyServices service;
        //private readonly ILogger<CurrenciesController> logger;

        public CurrenciesController(ICurrencyServices service)
        {
        ...
        [HttpPost]
        public IActionResult Post([FromBody] Tbcurrency t)
        {
        ...
        [HttpPut("{id}")]
        public IActionResult Put(string id, [FromBody] Tbcurrency t)
        {
