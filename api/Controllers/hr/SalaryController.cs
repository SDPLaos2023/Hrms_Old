...
namespace hrm_api.Controllers.hr
{
    ...
    public class SalaryController : ControllerBase
    {
        ...
        public ISalaryTypeServices service { get; }

        public SalaryController(ILogger<SalaryController> logger, ISalaryTypeServices service)
        {
            this._logger = logger;
        ...
        [HttpPost]
        public IActionResult Post([FromBody] TbsalaryType t)
        {
        ...
        [HttpPut("{id}")]
        public IActionResult Put(string id, [FromBody] TbsalaryType t)
        {
