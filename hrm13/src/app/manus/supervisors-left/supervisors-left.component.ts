...
@Component({
  selector: 'app-supervisors-left',
  templateUrl: './supervisors-left.component.html',
  styleUrls: ['./supervisors-left.component.css']
})
export class SupervisorsLeftComponent implements OnInit {
