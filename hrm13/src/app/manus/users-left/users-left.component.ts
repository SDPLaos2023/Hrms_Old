...
@Component({
  selector: 'app-users-left',
  templateUrl: './users-left.component.html',
  styleUrls: ['./users-left.component.css']
})
export class UsersLeftComponent implements OnInit, AfterViewInit {
