...
import { ModalSalarayPayTypeComponent as ModalSalaryPayTypeComponent } from 'src/app/components/modals/modal-salaray-pay-type/modal-salaray-pay-type.component';
...
@Component({
  selector: 'app-salary-pay-types',
  templateUrl: './salary-pay-types.component.html',
  styleUrls: ['./salary-pay-types.component.css']
})
export class SalaryPayTypesComponent implements OnInit, AfterViewInit {
  ...
  constructor(private page: PageDataService, private spinner: NgxSpinnerService,
    ...
    private service: SalaryPayTypeService) { }
  ...
  ngOnInit(): void {
    this.page.pagename = "ຂໍ້ມູນຮູບແບບການຈ່າຍເງິນເດືອນ"
  ...
  openDialog() {
    const dialogRef = this.dialog.open(ModalSalaryPayTypeComponent, {
      width: '600px',
    });
