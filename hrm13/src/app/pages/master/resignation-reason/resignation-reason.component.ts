...
import { ModalResignationReasonComponent } from 'src/app/components/modals/modal-resignation-reason/modal-resignation-reason.component';
import { ResignationReason } from 'src/app/models/resignation-reason.model';
...
@Component({
  selector: 'app-resignation-reason',
  templateUrl: './resignation-reason.component.html',
  styleUrls: ['./resignation-reason.component.css']
})
export class ResignationReasonComponent implements OnInit, AfterViewInit {

  contractTypes: ResignationReason[] = []
  ...
  constructor(private page: PageDataService, private spinner: NgxSpinnerService, public dialog: MatDialog,
    private service: ResignationReasonService) { }
  ...
  ngOnInit(): void {
    this.page.pagename = "ຂໍ້ມູນເຫດຜົນການລາອອກ"
    this.page.breadcrumb = '<li class="breadcrumb-item"> <i class="fas fa-home"></i> Home</li><li class="breadcrumb-item"> ການຈັດການຂໍ້ມູນພື້ນຖານ </li> <li class="breadcrumb-item active" > ຂໍ້ມູນເຫດຜົນການລາອອກ </li>'
    // this.spinner.show();
    this.LoadAll();
  }
  ...
  openDialog() {
    const dialogRef = this.dialog.open(ModalResignationReasonComponent, {
      width: '600px',
    });
