...
import { ModalEmployeeCategoryComponent } from 'src/app/components/modals/modal-employee-category/modal-employee-category.component';
...
export class EmployeeCategoriesComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    this.page.pagename = "ຂໍ້ມູນຫມວດຫມູ່ພະນັກງານ"
    this.page.breadcrumb = '<li class="breadcrumb-item"> <i class="fas fa-home"></i> Home</li><li class="breadcrumb-item"> ການຈັດການຂໍ້ມູນພື້ນຖານ </li> <li class="breadcrumb-item active" > ຂໍ້ມູນຫມວດຫມູ່ພະນັກງານ </li>'
    this.LoadAll();
  }
  ...
  openDialog() {
    const dialogRef = this.dialog.open(ModalEmployeeCategoryComponent, {
      width: '600px',
    });
