...
import { ModalEmployeeGroupComponent } from 'src/app/components/modals/modal-employee-group/modal-employee-group.component';
...
@Component({
  ...
  styleUrls: ['./employee-groups.component.css']
})
export class EmployeeGroupsComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    this.page.pagename = "ຂໍ້ມູນປະເພດກຸ່ມພະນັກງານ"
    this.page.breadcrumb = '<li class="breadcrumb-item"> <i class="fas fa-home"></i> Home</li><li class="breadcrumb-item"> ການຈັດການຂໍ້ມູນພື້ນຖານ </li> <li class="breadcrumb-item active" > ຂໍ້ມູນປະເພດກຸ່ມພະນັກງານ </li>'
    this.LoadAll();
  }
  ...
  openDialog() {
    const dialogRef = this.dialog.open(ModalEmployeeGroupComponent, {
      width: '600px',
    });
