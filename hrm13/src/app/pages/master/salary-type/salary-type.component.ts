...
import { ModalSalaryTypeComponent } from 'src/app/components/modals/modal-salary-type/modal-salary-type.component';
...
export class SalaryTypeComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    this.page.pagename = "ຂໍ້ມູນເພດເງິນເດືອນ"
    this.page.breadcrumb = '<li class="breadcrumb-item"> <i class="fas fa-home"></i> Home</li><li class="breadcrumb-item"> ການຈັດການຂໍ້ມູນພື້ນຖານ </li> <li class="breadcrumb-item active" > ຂໍ້ມູນເພດເງິນເດືອນ </li>'
    // this.spinner.show();
    this.LoadAll();
  }
  ...
  openDialog() {
    const dialogRef = this.dialog.open(ModalSalaryTypeComponent, {
      width: '600px',
    });
