...
import { ModalEducationDegreeTypeComponent } from 'src/app/components/modals/modal-education-degree-type/modal-education-degree-type.component';
...
@Component({
  selector: 'app-edication-degree-type',
  templateUrl: './edication-degree-type.component.html',
  styleUrls: ['./edication-degree-type.component.css']
})
export class EdicationDegreeTypeComponent implements OnInit, AfterViewInit {
  ...
  constructor(private page: PageDataService, private spinner: NgxSpinnerService, public dialog: MatDialog,
    private service: EducationDegreeTypeService) { }
  ...
  ngOnInit(): void {
    this.page.pagename = "ຂໍ້ມູນລະດັບການສຶກສາ"
    this.page.breadcrumb = '<li class="breadcrumb-item"> <i class="fas fa-home"></i> Home</li><li class="breadcrumb-item"> ການຈັດການຂໍ້ມູນພື້ນຖານ </li> <li class="breadcrumb-item active" > ຂໍ້ມູນລະດັບການສຶກສາ </li>'
    // this.spinner.show();
    this.LoadAll();
  }
  ...
  openDialog() {
    const dialogRef = this.dialog.open(ModalEducationDegreeTypeComponent, {
      width: '600px',
    });
