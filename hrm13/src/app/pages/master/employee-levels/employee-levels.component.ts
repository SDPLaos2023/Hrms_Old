...
import { ModalEmployeeLevelComponent } from 'src/app/components/modals/modal-employee-level/modal-employee-level.component';
...
export class EmployeeLevelsComponent implements OnInit, AfterViewInit {
  ...
  constructor(private page: PageDataService, private spinner: NgxSpinnerService, public dialog: MatDialog,
    private service: EmployeeLevelService) { }
  ...
  ngOnInit(): void {
    this.page.pagename = "ຂໍ້ມູນລະດັບພະນັກງານ"
    this.page.breadcrumb = '<li class="breadcrumb-item"> <i class="fas fa-home"></i> Home</li><li class="breadcrumb-item"> ການຈັດການຂໍ້ມູນພື້ນຖານ </li> <li class="breadcrumb-item active" > ຂໍ້ມູນລະດັບພະນັກງານ </li>'
    this.LoadAll();
  ...
  openDialog() {
    const dialogRef = this.dialog.open(ModalEmployeeLevelComponent, {
      width: '600px',
    });
