...
import { ModalBankComponent } from 'src/app/components/modals/modal-bank/modal-bank.component';
...
export class BanksComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    this.page.pagename = "ຂໍ້ມູນທະນາຄານ"
    this.page.breadcrumb = '<li class="breadcrumb-item"> <i class="fas fa-home"></i> Home</li><li class="breadcrumb-item"> ການຈັດການຂໍ້ມູນພື້ນຖານ </li> <li class="breadcrumb-item active" > ຂໍ້ມູນທະນາຄານ </li>'
    this.LoadAll()
