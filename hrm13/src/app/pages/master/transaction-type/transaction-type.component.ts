...
import { ModalTransactionTypeComponent } from 'src/app/components/modals/modal-transaction-type/modal-transaction-type.component';
...
export class TransactionTypeComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    this.page.pagename = "ຂໍ້ມູນປະເພດການເຄື່ອນໄຫວ"
    this.page.breadcrumb = '<li class="breadcrumb-item"> <i class="fas fa-home"></i> Home</li><li class="breadcrumb-item"> ການຈັການຂໍ້ມູນບຸຄະລາກອນ </li> <li class="breadcrumb-item active" > ຂໍ້ມູນປະເພດການເຄື່ອນໄຫວ </li>'
    // this.spinner.show();
    this.LoadAll();
  }
  ...
  openDialog() {
    const dialogRef = this.dialog.open(ModalTransactionTypeComponent, {
      width: '600px',
    });
