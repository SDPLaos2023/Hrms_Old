...
import { ModalEmployeeTypeComponent } from 'src/app/components/modals/modal-employee-type/modal-employee-type.component';
...
export class EmployeeTypeComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    this.page.pagename = "ຂໍ້ມູນປະເພດພະນັກງານ"
    this.page.breadcrumb = '<li class="breadcrumb-item"> <i class="fas fa-home"></i> Home</li><li class="breadcrumb-item"> ການຈັດການຂໍ້ມູນພື້ນຖານ </li> <li class="breadcrumb-item active" > ຂໍ້ມູນປະເພດພະນັກງານ </li>'
    this.LoadAll();
  }
  ...
  openDialog() {
    const dialogRef = this.dialog.open(ModalEmployeeTypeComponent, {
      width: '600px',
    });
