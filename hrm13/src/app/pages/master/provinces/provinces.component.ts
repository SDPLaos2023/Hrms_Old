...
import { ModalProvinceComponent } from 'src/app/components/modals/modal-province/modal-province.component';
...
export class ProvincesComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    this.page.pagename = "ຂໍ້ມູນແຂວງ"
    this.page.breadcrumb = '<li class="breadcrumb-item"> <i class="fas fa-home"></i> Home</li><li class="breadcrumb-item"> ການຈັດການຂໍ້ມູນພື້ນຖານ </li> <li class="breadcrumb-item active" > ຂໍ້ມູນແຂວງ </li>'
    // this.spinner.show();
    this.LoadAll();
  }
  ...
  openDialog() {
    const dialogRef = this.dialog.open(ModalProvinceComponent, {
      width: '600px',
    });
  ...
  GotoDistrict(id: any) {
    this.route.navigate(['provinces/districts/' + id])
  }
