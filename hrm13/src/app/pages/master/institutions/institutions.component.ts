...
import { ModalInstitutionComponent } from 'src/app/components/modals/modal-institution/modal-institution.component';
...
export class InstitutionsComponent implements OnInit, AfterViewInit {
  ...
  list: EducationInstitution[] = []
  dtOptions: DataTables.Settings = {};
  @ViewChild(DataTableDirective, { static: false })
  dtElement: DataTableDirective;
  dtTrigger: Subject<any> = new Subject();

  constructor(private service: EducationInstitutionService,
    private page: PageDataService, private spinner: NgxSpinnerService, public dialog: MatDialog) { }
  ...
  ngOnInit(): void {
    ...
    this.page.pagename = "ຂໍ້ມູນສະຖານສຶກສາ"
    this.page.breadcrumb = '<li class="breadcrumb-item"> <i class="fas fa-home"></i> Home</li><li class="breadcrumb-item"> ການຈັດການຂໍ້ມູນພື້ນຖານ </li> <li class="breadcrumb-item active" > ຂໍ້ມູນສະຖານສຶກສາ </li>'
    // this.spinner.show();
    this.LoadAll();
  }
  ...
  openDialog() {
    const dialogRef = this.dialog.open(ModalInstitutionComponent, {
      width: '600px',
    });
