...
export class UserProfileComponent implements OnInit {
  ...
  constructor(private page: PageDataService, private datepipe: DatePipe,
    ...
    this.employee = JSON.parse(JSON.parse(this.util.decryptUsingAES256(this.username)));
  }
  ...
  LoadEmployee(employee: string) {
    this.emp.GetEmployee(employee).subscribe((resp: any) => {
      ...
      resp.dob = dob
      let family = resp.tbemployeeFamilyContacts[0]
      ...
      let contract = resp.tbemployeeContracts[0]
      ...
      let proContract = resp.tbemployeeProbations[0]
      ...
      let insurance = resp.tbemployeeInsurances[0]
  ...
  ngOnInit(): void {
    ...
    this.page.pagename = "User Profile"
    this.page.breadcrumb = '<li class="breadcrumb-item"> <i class="fas fa-home"></i> Home</li> <li class="breadcrumb-item active" > ' + this.page.pagename + ' </li>'
  ...
  SaveEmployeeInfo() {
    ...
    this.emp.NewEmployee(this.formxx.value).subscribe((rs: any) => {
      ...
      let classifyId = rs.tbemployeeClassifications[0].id === undefined ? "" : rs.tbemployeeClassifications[0].id;
      let familyContactId = rs.tbemployeeFamilyContacts[0].id === undefined ? "" : rs.tbemployeeFamilyContacts[0].id;
      let contactId = rs.tbemployeeContacts[0].id === undefined ? "" : rs.tbemployeeContacts[0].id;
      let proContactId = rs.tbemployeeProbations[0].id === undefined ? "" : rs.tbemployeeProbations[0].id;
      let contractId = rs.tbemployeeContracts[0].id === undefined ? "" : rs.tbemployeeContracts[0].id;
      let employmentId = rs.tbemployeeEmployments[0].id === undefined ? "" : rs.tbemployeeEmployments[0].id;
      let salarySettingId = rs.tbemployeeSalarySettings[0].id === undefined ? "" : rs.tbemployeeSalarySettings[0].id;
      let leaveSettingId = rs.tbemployeeLeaveSettings[0].id === undefined ? "" : rs.tbemployeeLeaveSettings[0].id;
      let insuranceId = rs.tbemployeeInsurances[0].id === undefined ? "" : rs.tbemployeeInsurances[0].id;
