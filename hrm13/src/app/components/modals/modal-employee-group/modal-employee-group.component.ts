...
@Component({
  selector: 'app-modal-employee-group',
  templateUrl: './modal-employee-group.component.html',
  styleUrls: ['./modal-employee-group.component.css']
})
export class ModalEmployeeGroupComponent implements OnInit {
  form: FormGroup
  isUpdate: boolean;
  constructor(public dialogRef: MatDialogRef<ModalEmployeeGroupComponent>,
    private service: EmployeeGroupService, private spinner: NgxSpinnerService, @Inject(MAT_DIALOG_DATA) public data: any) {
