...
@Component({
  selector: 'app-modal-salaray-pay-type',
  templateUrl: './modal-salaray-pay-type.component.html',
  styleUrls: ['./modal-salaray-pay-type.component.css']
})
export class ModalSalarayPayTypeComponent implements OnInit {
  formWt: FormGroup
  isUpdate: boolean;
  constructor(public dialogRef: MatDialogRef<ModalSalarayPayTypeComponent>,
    private sectionService: SalaryPayTypeService, private spinner: NgxSpinnerService,
