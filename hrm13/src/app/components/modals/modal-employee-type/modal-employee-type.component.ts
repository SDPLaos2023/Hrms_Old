...
@Component({
  selector: 'app-modal-employee-type',
  templateUrl: './modal-employee-type.component.html',
  styleUrls: ['./modal-employee-type.component.css']
})
export class ModalEmployeeTypeComponent implements OnInit {
  form: FormGroup
  isUpdate: boolean;
  constructor(public dialogRef: MatDialogRef<ModalEmployeeTypeComponent>,
    private service: EmployeeTypeService, private spinner: NgxSpinnerService, @Inject(MAT_DIALOG_DATA) public data: any) {
