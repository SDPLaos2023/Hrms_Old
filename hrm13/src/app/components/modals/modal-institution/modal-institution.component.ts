...
@Component({
  ...
  styleUrls: ['./modal-institution.component.css']
})
export class ModalInstitutionComponent implements OnInit {

  form: FormGroup
  isUpdate: boolean;
  constructor(public dialogRef: MatDialogRef<ModalInstitutionComponent>,
    private service: EducationInstitutionService, private spinner: NgxSpinnerService, @Inject(MAT_DIALOG_DATA) public data: any) {
