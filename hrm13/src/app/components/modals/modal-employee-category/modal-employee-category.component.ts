...
@Component({
  selector: 'app-modal-employee-category',
  templateUrl: './modal-employee-category.component.html',
  styleUrls: ['./modal-employee-category.component.css']
})
export class ModalEmployeeCategoryComponent implements OnInit {
  form: FormGroup
  isUpdate: boolean;
  constructor(public dialogRef: MatDialogRef<ModalEmployeeCategoryComponent>,
    private service: EmployeeCategoryService, private spinner: NgxSpinnerService, @Inject(MAT_DIALOG_DATA) public data: any) {
