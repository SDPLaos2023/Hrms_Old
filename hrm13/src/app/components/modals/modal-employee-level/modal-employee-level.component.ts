...
@Component({
  selector: 'app-modal-employee-level',
  templateUrl: './modal-employee-level.component.html',
  styleUrls: ['./modal-employee-level.component.css']
})
export class ModalEmployeeLevelComponent implements OnInit {
  form: FormGroup
  isUpdate: boolean;
  constructor(public dialogRef: MatDialogRef<ModalEmployeeLevelComponent>,
    private service: EmployeeLevelService, private spinner: NgxSpinnerService, @Inject(MAT_DIALOG_DATA) public data: any) {
